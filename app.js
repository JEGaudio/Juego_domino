...
tbody3.addEventListener('click', function (e) {
    ...
    let carta_seleccionada = recuperar_array_seleccion(cartas,true,"nada");
    let pos_y = carta_seleccionada[0].PosY;      
    let pos_x = carta_seleccionada[0].PosX;
    
    
    console.log("lado 1 carta seleccionada: " + carta_seleccionada[0].lado1);
    console.log("lado 2 carta seleccionada: " + carta_seleccionada[0].lado2);
    ...
    if (carta_seleccionada[0].lado1 == juego[cell.cellIndex].lado1) {
        carta_seleccionada[0].Num = rotar_ficha(carta_seleccionada[0].Num);
        document.getElementById("row_juego").insertCell(cell.cellIndex).innerHTML = carta_seleccionada[0].Num;
        juego.unshift(carta_seleccionada[0]);
        console.log(juego);
    ...
    if (carta_seleccionada[0].lado2 == juego[cell.cellIndex].lado1) {
        document.getElementById("row_juego").insertCell(cell.cellIndex).innerHTML = carta_seleccionada[0].Num;
        juego.unshift(carta_seleccionada[0]);
        cartas[pos_x][pos_y].Seleccion = false;
        cartas[pos_x][pos_y].Estado = "juego";
    ...
    if (carta_seleccionada[0].lado1 == juego[cell.cellIndex].lado2) {
        document.getElementById("row_juego").insertCell(cell.cellIndex+1).innerHTML = carta_seleccionada[0].Num;
        juego.push(carta_seleccionada[0]);
        cartas[pos_x][pos_y].Seleccion = false;
        cartas[pos_x][pos_y].Estado = "juego";
        //console.log(cartas[pos_x][pos_y]);
        actualizar_clases();
    ...
    if (carta_seleccionada[0].lado2 == juego[cell.cellIndex].lado2) {
        carta_seleccionada[0].Num = rotar_ficha(carta_seleccionada[0].Num);
        document.getElementById("row_juego").insertCell(cell.cellIndex+1).innerHTML = carta_seleccionada[0].Num; 
        juego.push(carta_seleccionada[0]);
        cartas[pos_x][pos_y].Seleccion = false;
...
function actualizar_clases(){
    const tbody = document.querySelectorAll('#posicion_fichas td');
    //console.log(tbody);
